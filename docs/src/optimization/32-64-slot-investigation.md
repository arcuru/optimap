...
- **insert**: Tied. 16-slot `UFM` (6.2 ns), 32-slot `Byte1_1bit32` (6.3 ns).
- **lookup_hit**: Tied. 16-slot `Byte7_128_1bitAnd` (2.1 ns), 32-slot `Byte7_128_1bitAnd32` (2.1 ns).
- **lookup_miss**: 16-slot wins. `hashbrown` (1.2 ns), `Byte0_128_8bit` (1.4 ns) vs best 32-slot `Splitsies32` (1.5 ns).
- **remove**: 16-slot wins slightly. `Byte7_255Ch_EmbP2And` (12.6 ns) vs `Byte7_255_1bitAnd32` (11.3 ns) vs `Byte7_128_Tomb` (11.2 ns).
...
- At 1.0M N: `Byte7_128_1bitAnd32` (6.4 ns) vs `Byte7_128Ch_EmbP2And` (6.3 ns)
...
- At 1.0M N: `Splitsies32` (3.2 ns) vs `Byte1_EmbP2` / `Gaps` (3.0 ns)
...
- `Ufm32` vs `UFM` shows the two lines crossing repeatedly between 30 and 45 ns/op at large scale. Overall, there is no clear victor, though Tombstone designs (`Byte7_128_Tomb`, 24.5 ns) significantly outperform all overflow-bit designs on this workload.
...
3. **No immediate architectural changes required.** `Byte7_128_Tomb` remains the best general-purpose map, and 16-slot `Splitsies` / `UFM` remain the best tombstone-free variants.
