...
|---|------|-----------|-------|
| 14 | Extend `OptiMap` with FlatBTree backend + `sorted` criterion in policy; remove `OptiSortedMap` (it becomes a special case of `OptiMap`). | Medium | Per the agreed "one wrapper to rule them all" architecture. |
