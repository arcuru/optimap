...
set linetype 14 lc rgb "#b2182b" lw 1.5 dt 4       # Top128_Tomb (dark red, dotted)
set linetype 15 lc rgb "#4393c3" lw 2.0 dt 3       # Top128_1bitAnd (steel blue, dash-dot)
set linetype 16 lc rgb "#d73027" lw 2.0 dt 3       # Top255_1bitAnd (bright red, dash-dot)
...
do for [i=1:words(operations)] {
    ...
    plot \
        ...
        sprintf("< awk -F, '$1==\"%s\" && $2==\"Top128_Tomb\"' '%s'", op, csv) using 3:4 with lines lt 14 title "Top128_Tomb", \
        sprintf("< awk -F, '$1==\"%s\" && $2==\"Top128_1bitAnd\"' '%s'", op, csv) using 3:4 with lines lt 15 title "Top128_1bitAnd", \
        sprintf("< awk -F, '$1==\"%s\" && $2==\"Top255_1bitAnd\"' '%s'", op, csv) using 3:4 with lines lt 16 title "Top255_1bitAnd"
}
